...
const char* password = "123456789w";

WiFiServer server1(8001);//port
...
void loop() {
    ...
    // delay(5000); 
    Serial.print(WiFi.localIP());
    WiFiClient client = server1.available();   // listen clients
      ...
      if (client.available()) {           
        ...
        if (c == '\n') {                    
          ...
          if (currentLine.length() == 0) {
            ...
            // ON/OFF
            client.println("<p>Red LED - State " + output13State + "</p>");
